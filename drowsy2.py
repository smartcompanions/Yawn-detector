...
landmark_model = dlib.shape_predictor("C:\\Users\\christy chacko\\Desktop\\drowsy\\shape_predictor_68_face_landmarks.dat")
...
while True :
    ...
    for face in faces:
        ...
        cv2.drawContours(frame,[lip2],-1,(0, 165, 255),thickness = 3)
